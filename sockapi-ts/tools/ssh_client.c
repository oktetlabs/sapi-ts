 ...
 *
 * @objective Establish and check SSH connection between ssh client and
 *            ssh server (sshd) using `true` comand.
 *
...
main(int argc, char *argv[])
{
    ...
    iut_ssh_opt.destination = te_sockaddr_get_ipstr(tst_addr);
